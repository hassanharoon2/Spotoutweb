<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContactUs.aspx.cs" Inherits="Prisolo_Updated.ContactUs" %>
...
<body>
    <form runat="server">
        ...
        <main>
            <div class="aboutMainBanner" style="background: linear-gradient(rgba(0,0,0,.5),rgba(0,0,0,.5)),url(Content/img/Banners/contactus.jpg); background-size: cover; padding: 160px 0;">
                <div class="container">
                    ...
                    <div class="row m-0 justify-content-center">
                        <div class="col-md-7">
                            <div class="form-group">
                                <label>Email</label>
                                <asp:TextBox ID="EmailSendTextBox" CssClass="form-control" placeholder="Enter Email" runat="server"></asp:TextBox>
                            </div>
                            <div class="form-group">
                                <label>Subject</label>
                            ...
                            <div class="form-group">
                                <label>Message</label>
                                <asp:TextBox ID="TextBox2" TextMode="MultiLine" Rows="5" CssClass="form-control" placeholder="Enter Email" runat="server"></asp:TextBox>
                            </div>
                            <div class="form-group">
                                <asp:LinkButton ID="SendEmailButton" CssClass="btn btn-primary" runat="server">Submit</asp:LinkButton>
                            </div>
                        </div>
                        <div class="col-md-5 mt-md-4 pt-md-4">
                            <div class="followUs">
